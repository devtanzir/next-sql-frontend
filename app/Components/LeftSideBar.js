...
import DuaLogo from "@/public/nav-Icons/dua-logo.svg";
import books from "@/public/nav-Icons/books.svg";
    ...
    <>
      <div className="left-navbar shadow-md">
        ...
        <div className="middle-links">
          <Link href="/" className="route-links">
            <Image src={HomeSvg} alt="Home"></Image>
          </Link>
          <Link href="/" className="route-links">
            <Image src={alldua} alt="all Data"></Image>
          </Link>
          <Link href="/" className="route-links">
            <Image src={bookmark} alt="Bookmark"></Image>
          </Link>
          <Link href="/" className="route-links">
            <Image src={ruqyah} alt="Ruqyah"></Image>
          </Link>
          <Link href="/" className="route-links">
            <Image src={DuaInfo} alt="DuaInfo"></Image>
          </Link>
          <Link href="/" className="route-links">
            <Image src={books} alt="Books"></Image>
          </Link>
        </div>
